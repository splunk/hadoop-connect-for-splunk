 ...
 * @author Doc Yes
 */
Splunk.Module.HDFSIFrameInclude = $.klass(Splunk.Module, {
    IFRAME_HEIGHT_FIX: 0,
    ONLOAD_TIMEOUT: 0,
    /**
    ...
    initialize: function($super, container){
        $super(container);
        this.logger = Splunk.Logger.getLogger("Splunk.Module.HDFSIFrameInclude");
    ...
    onLoad: function(event){
        this.logger.info("HDFSIFrameInclude onLoad event fired.");

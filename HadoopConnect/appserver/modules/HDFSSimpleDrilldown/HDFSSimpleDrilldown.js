...
Splunk.Module.HDFSSimpleDrilldown = $.klass(Splunk.Module, {
    initialize: function($super, container){
        ...
        if (typeof links === 'string') {
            try {
                ...
                console.error('Unable to parse links parameter of HDFSSimpleDrilldown module');
            }
        }
        this.links = links;
    },
    ...
    _inflateLink: function(link, context) {
        ...
        for (var i=0; i<tokens.length; i++) {
            ...
            var replacer = new RegExp("\\$" + this.escapeRegex(key) + "\\$");
    ...
    _redirectToUrl: function(link, click) {
        ...
        var openInPopup = click.modifierKey || Splunk.util.normalizeBoolean(this.getParam("newWindow")) || false;
        if (openInPopup) {
